...
def get_train_args_parser():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="make the workers of dataloader persistent",
    )
    ...
    parser.add_argument(
        "--profile_logging_path",
        help="logging path of profiling, cannot be empty when enabled",
    )
    parser.add_argument(
        "--pin_memory",
        action="store_true",
    ...
    parser.add_argument(
        "--enable_autograd_detect_anomaly",
        action="store_true",
        help="enable the anomaly detection for the autograd engine",
    )
    parser.add_argument("--wandb_run_offline",
                        action="store_true",
