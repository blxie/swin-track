from data.tracking.sampler.SiamFC.dataset_sampler import (
    SOTTrackingSiameseForwardIteratorDatasetSampler,
...
from data.tracking.dataset.dataset import (
    ...
    RandomAccessIteratorWrapperDataset,
)
...
def build_siamfc_dataset(
    ...
    sequence_picker, is_random_accessible_dataset = build_dataset_sampler(
        datasets,
        dataset_parameters,
        sampling_config,
        master_address,
    ...
    if is_random_accessible_dataset:
        sampler = SOTTrackingSiameseRandomAccessIteratorDatasetSampler(
            ...
            enforce_fine_positive_sample,
            sequence_sampling_method,
            enable_adaptive_frame_range,
            negative_sample_random_picking_ratio,
            default_frame_range,
            dataset_sampling_parameters,
