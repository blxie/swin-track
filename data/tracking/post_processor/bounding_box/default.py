...
class DefaultBoundingBoxPostProcessor:
    ...
    def __init__(self,
        ...
        assert input_format in (BoundingBoxFormat.XYXY,
    ...
    def __call__(self, bbox_normalized, curation_parameter):
        ...
        curation_scaling, curation_source_center_point, curation_target_center_point = curation_parameter.unbind(
            dim=-2)
        bbox = self.bbox_normalizer.denormalize(bbox_normalized,
        ...
        bbox = bbox_scale_and_translate_vectorized(
            bbox, 1.0 / curation_scaling, curation_target_center_point,
...
def build_bounding_box_post_processor(network_config: dict):
    return DefaultBoundingBoxPostProcessor(
