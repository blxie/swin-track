def build_response_map_post_processor(response_map_parameters,
                                      evaluation_config):
    from .response_map import ResponseMapTrackingPostProcessing
    network_post_processor = ResponseMapTrackingPostProcessing(
        evaluation_config['window_penalty'] > 0,
        response_map_parameters['size'], evaluation_config['window_penalty'])
