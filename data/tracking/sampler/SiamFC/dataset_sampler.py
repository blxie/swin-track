            ...
            if isinstance(dataset, DetectionDataset_MemoryMapped):
                ...
                if self.enforce_fine_positive_sample:
                    ...
                    data = (sampled_data[0][0], sampled_data[0][1],
                            sampled_data[1][0], sampled_data[1][1], True)
                else:
                    if isinstance(dataset,
                                  SingleObjectTrackingDataset_MemoryMapped):
                    ...
                    if is_positive == 0:
                        data = (sampled_data[0][0], sampled_data[0][1],
                                sampled_data[0][0], sampled_data[0][1], True)
                    else:
                        data = (sampled_data[0][0], sampled_data[0][1],
                                sampled_data[1][0], sampled_data[1][1],
                                is_positive == 1)
            else:
                raise NotImplementedError
        else:
...
class SOTTrackingSiameseForwardIteratorDatasetSampler(
        _BaseSOTTrackingSiameseIterableDatasetSampler):
    ...
    def __init__(self,
        ...
        super(SOTTrackingSiameseForwardIteratorDatasetSampler, self).__init__(
            ...
            enforce_fine_positive_sample, sampling_method,
            adaptive_frame_range, negative_sample_random_picking_ratio,
            default_frame_range, datasets_sampling_parameters,
