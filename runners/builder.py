...
def build_runner(model, runner_config, data_source_context, config,
    ...
    if runner_config['type'] == 'default':
        ...
        return build_default_training_runner(model, runner_config,
                                             data_source_context, config,
                                             event_register)
    # TRACED default_evaluation
    elif runner_config['type'] == 'default_evaluation' or runner_config[
            'type'] == 'coarse_to_fine_evaluation':
