...
class SingleObjectTrackingDatasetFactory(DatasetFactory):
    ...
    def __init__(self, seeds: list):
        super(SingleObjectTrackingDatasetFactory, self).__init__(
            seeds,
            VideoDataset,
    ...
    def construct(
        self,
        filters: list = None,
        cache_base_format: bool = True,
        dump_human_readable: bool = False,
    ) -> List[SingleObjectTrackingDataset_MemoryMapped]:
        return super(SingleObjectTrackingDatasetFactory,
                     self).construct(filters, cache_base_format,
                                     dump_human_readable)
    ...
    def construct_as_base_interface(
            ...
            filters=None,
            make_cache=False,
            dump_human_readable=False) -> List[VideoDataset]:
        return super(SingleObjectTrackingDatasetFactory,
                     self).construct_as_base_interface(filters, make_cache,
                                                       dump_human_readable)
